...
## Background
  This project originates from the module **NSCI0036: Programming for Scientists 24/25** in the Department of Natural Sciences at UCL. The project outcomes, including the Python code and the project report, are provided for educational purposes and for those interested in practising cellular automaton model development in Python.
